...
public class InputSsidPasswordDialog extends Dialog implements TextWatcher {
    ...
    /*private void initDpmSet() {
        DeviceControlActivity.sleepMode = -1;
        DeviceControlActivity.rtcDefault = -1;
        DeviceControlActivity.rtcTimer = -1;
        DeviceControlActivity.useDPM = -1;
        DeviceControlActivity.dpmDefault = -1;
        DeviceControlActivity.dpmKeepAlive = -1;
        DeviceControlActivity.userWakeup = -1;
        DeviceControlActivity.timWakeup = -1;
    }*/
