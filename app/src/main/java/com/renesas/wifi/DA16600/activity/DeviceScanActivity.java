...
public class DeviceScanActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (btn_scan_start.getVisibility() == View.VISIBLE) {
            btn_scan_start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //listView.setBackground(getResources().getDrawable(R.drawable.border));
        ...
        //progressScanning.set.setIndicatorColor(getResources().getColor(R.color.blue3));
        //]]
        ...
        //[[modify in v2.4.12 because it was deprecated.
        //listView.setBackground(getResources().getDrawable(R.drawable.no_border));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Build.VERSION.SDK_INT >= 31) {  //add condition in v2.4.3
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (deviceName != null && deviceName.length() > 0) {
                ...
                /*if (deviceName.equals(exampleName)) {
