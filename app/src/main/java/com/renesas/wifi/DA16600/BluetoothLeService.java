...
public class BluetoothLeService extends Service {
    ...
    //private boolean mSubscribedForNotifications = false;
    //]]
    ...
    public enum WIFI_ACTION_RESULT {
        ...
        //COMBO_WIFI_CMD_SET_DPM_SUCCESS,
        COMBO_WIFI_PROV_WRONG_PW, //103
        //COMBO_WIFI_CMD_SET_DPM_FAIL,
    ...
    @SuppressLint("MissingPermission")  //add in v2.4.12
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            ...
            final String status_str = status == BluetoothGatt.GATT_SUCCESS ? "SUCCESS" : "ERROR";
            MyLog.i( ">> onDescriptorWrite: descriptor=" + descriptor.getUuid() + ", status=" + status + " (" + status_str +")");*/
        ...
        private void broadcastUpdate(final String action,
            ...
            if (WIFI_SVC_UUID.equals(characteristic.getUuid())) {
                ...
                if (remaining_len > 0) {
                    ...
                    if (sb != null && DeviceControlActivity.getInstance() != null) {  //modify in v2.3.4
                        ...
                        if (jsonObject != null) {
                            ...
                            if (jsonObject.has("result")) {
                                ...
                                if (result == 101) {
                                    ...
                                    //MyLog.i("DeviceControlActivity.sleepMode = "+DeviceControlActivity.sleepMode);
                                /*DeviceControlActivity.getInstance().sendDPMinfo(DeviceControlActivity.sleepMode,
                                        DeviceControlActivity.rtcTimer,
                                        DeviceControlActivity.useDPM,
                                        DeviceControlActivity.svrUrl,
                                        DeviceControlActivity.dpmKeepAlive,
                                        DeviceControlActivity.userWakeup,
                                        DeviceControlActivity.timWakeup);*/
                                ...
                                editor.commit();*/
                                    ...
                                    //DeviceControlActivity.fromSetup = false;
                                    ...
                                    int count = 0;
                                /*DeviceControlActivity.getInstance().sendAPinfo(StaticDataSave.networkSSID,
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        //[[add in v2.4.12
        /*if (mSubscribedForNotifications) {
            return;
        }*/
        //]]
        ...
        //[[add in v2.4.12 for subscription
        if (StaticDataSave.device.equals("RRQ61400")) {
            try {
                Thread.sleep(100);
            } catch (Exception e) {
        ...
        //[[add in v2.4.12
            ...
            //[[modify in v2.4.12
            //MyLog.i( "WIFI_SVC_WFACT_RES notification!!");
        ...
        //]]
            ...
            //[[modify in v2.4.12
            //MyLog.i( "WIFI_SVC_PROV_DATA_UUID notification!!");
            MyLog.i("Subscribed to WIFI_SVC_WFACT_RES notification [" + characteristic.getUuid().toString() + "]");
            //]]
            try {
                Thread.sleep(100);
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic, String stringData) {
        //[[remove in v2.4.12
        //MyLog.i("BluetoothLeService :: writeCharacteristic");
        //]]
    ...
    public WIFI_ACTION_RESULT getWiFiActionResult(int intResponse) {
        ...
        if (intResponse == 1) {
            ...
            //actionResult = WIFI_ACTION_RESULT.COMBO_WIFI_CMD_SET_DPM_SUCCESS;
