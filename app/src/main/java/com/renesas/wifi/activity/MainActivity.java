...
import com.renesas.wifi.BuildConfig;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    //[[add in v2.4.8 for Celeno
    //[[remove in v2.4.9
    /*private FButton btn_rrq66620_softap;
    private FButton btn_rrq66620_ble;*/
    //]]
    //]]

    //[[for DPP
    //private FButton btn_dpp;
    //]]

    //private FButton btn_visit_support;
    //private FButton btn_init;
    ...
    private MaterialDialog azureDeviceFailDialog = null;  //add in v2.3.15
        ...
        public void handleMessage(Message msg) {
            ...
            if (act != null)
            {
                switch (msg.what)
                {
                    ...
                    /*case HandleMsg.E_MAIN_SUPPORT_CALL:
                    {
                        MyLog.i(" E_MAIN_SUPPORT_CALL  ~ ");
                        Intent main = new Intent(mContext, SupportActivity.class);
                        main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        act.startActivity(main);
                        act.finishAffinity();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //[[add in v2.4.8 for Celeno
        //[[remove in v2.4.9
        /*btn_rrq66620_softap = (FButton) findViewById(R.id.btn_rrq66620_softap);
        if (btn_rrq66620_softap != null) {
            btn_rrq66620_softap.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StaticDataSave.device = "RRQ66620";
                    mHandler.sendEmptyMessage(HandleMsg.E_MAIN_PROVISIONING_CALL);
                }
            });
        }

        btn_rrq66620_ble = (FButton) findViewById(R.id.btn_rrq66620_ble);
        if (btn_rrq66620_ble != null) {
            btn_rrq66620_ble.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StaticDataSave.device = "RRQ66620";
                    mHandler.sendEmptyMessage(HandleMsg.E_MAIN_BLE_PROVISIONING_CALL);
        ...
        //[[for DPP
        /*btn_dpp = (FButton) findViewById(R.id.btn_dpp);
        if (btn_dpp != null) {
            btn_dpp.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        isEasyConnectSupported = wifiManager.isEasyConnectSupported();
                        MyLog.i("isEasyConnectSupported : " + isEasyConnectSupported);
                        if (isEasyConnectSupported) {
                            startWifiQRCodeScanner(mContext);
                        } else {
        ...
        /*btn_visit_support = (FButton) findViewById(R.id.btn_visit_support);
        if (btn_visit_support != null) {
            btn_visit_support.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mHandler.sendEmptyMessage(HandleMsg.E_MAIN_SUPPORT_CALL);
                }
            });
        }*/


        /*btn_init = (FButton) findViewById(R.id.btn_init);
        if (btn_init != null) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.AWSLayout:
                ...
                if (StaticDataSave.mode == 10 || StaticDataSave.mode == 12) {  //General AWS IoT
                    ...
                    //[[remove in v2.4.0
                    /*if (StaticDataSave.thingName.contains("DOORLOCK") || StaticDataSave.thingName.contains("DoorLock")|| StaticDataSave.thingName.contains("doorlock")) {  //modify for Keith
                        ...
                        *//*if (mDrawer != null) {
                        ...
                        //startActivity(new Intent(mContext, AWSIoTDoorActivity.class));
                        Intent main = new Intent(mContext, AWSIoTDoorActivity.class);
                        main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(main);
                        finishAffinity();
                    ...
                    if (StaticDataSave.thingName.contains("SENSOR")) {
                        ...
                        //startActivity(new Intent(mContext, AWSIoTSensorActivity.class));
                        Intent main = new Intent(mContext, AWSIoTSensorActivity.class);
                        main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(main);
                        finishAffinity();
                    ...
                    //
                    //startActivity(new Intent(mContext, AWSIoTDeviceActivity.class));
                    Intent main = new Intent(mContext, AWSIoTDeviceActivity.class);
                    main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(main);
                    finishAffinity();
            ...
            case R.id.AzureLayout:
                //startActivity(new Intent(mContext, AzureIoTMainActivity.class));
                if (mDrawer != null) {
                    mDrawer.closeDrawer(GravityCompat.START);
                }
                if (StaticDataSave.mode == 20 || StaticDataSave.mode == 21) {  //modify in v2.3.16, Generic and AT-CMD Azure IoT
                    if (StaticDataSave.thingName != null && StaticDataSave.azureConString != null) {  //add condtion in v2.3.15
                        if (!StaticDataSave.thingName.isEmpty() && !StaticDataSave.azureConString.isEmpty()) {  //add condtion in v2.3.15
                            Intent main = new Intent(mContext, AzureIoTDoorActivity.class);
                            main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(main);
                            finishAffinity();
