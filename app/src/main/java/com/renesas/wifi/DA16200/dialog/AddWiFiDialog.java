    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //SelectNetworkActivity.getInstance().sendSSIDPW(StaticDataSave.networkSSID, StaticDataSave.networkPassword, StaticDataSave.isHidden, StaticDataSave.serverURL);
                //modify in v2.3.13
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StaticDataSave.networkSecurityNum = -1;  //add in v2.3.13
                StaticDataSave.isHidden = -1;
            }
        });
