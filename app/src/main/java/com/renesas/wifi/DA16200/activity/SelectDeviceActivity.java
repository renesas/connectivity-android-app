...
public class SelectDeviceActivity extends BaseActivity implements View.OnClickListener {
    ...
    //[[change in v2.4.11
    //private com.wang.avi.AVLoadingIndicatorView progressConnecting;
    ...
    //[[chagne in v2.4.11
    //com.wang.avi.AVLoadingIndicatorView progressScanning;
    ...
    //public boolean isRenesasRRQ66620 = false;  //remove in v2.4.9
    //]]
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //[[change in v2.4.11
        //progressConnecting = (com.wang.avi.AVLoadingIndicatorView) findViewById(R.id.progressConnecting);
        progressConnecting = (ProgressBar) findViewById(R.id.progressConnecting);
        //progressConnecting.setIndicatorColor(getResources().getColor(R.color.blue3));
        //]]
        ...
        //[[remove in v2.3.17
        /*mHandler.sendEmptyMessageDelayed(HandleMsg.DIALOG_AP_CONNECT_TIMEOUT, 120000);
        if (WIFIUtil.getSSID(mContext).equals("Dialog_DA16200")) {
            mHandler.sendEmptyMessageDelayed(HandleMsg.DIALOG_AP_CONNECTED, 1000);
        } else {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (deviceRowItems.size() > 0) {
                    ...
                    //[[change in v2.4.7
                    //WIFIUtil.getInstance().removeWifiSpecialSSID(mContext, getCurrentSsid(mContext));
                    ...
                    //WIFIUtil.setDefaultNetworkForNoInternet(mContext);  //remove 221128
                    //[[change in v2.4.7
                    //onWifiConnect(StaticDataSave.deviceSSID, StaticDataSave.devicePassword);
                    WifiUtils.withContext(getApplicationContext())
                            ...
                            .onConnectionResult(new ConnectionSuccessListener() {
                                @Override
                                public void success() {
                                    //Toast.makeText(SelectDeviceActivity.this, "SUCCESS!", Toast.LENGTH_SHORT).show();
                                    currentSSID = WIFIUtil.getSSID(mContext);
    ...
    protected void onDestroy() {
        ...
        //[[add in v2.3.19
        //remove for Mirador
        //WIFIUtil.getInstance().removeWifiSpecialSSID(mContext, StaticDataSave.deviceSSID);
        //]]
    ...
    public void onBackPressed() {
        ...
        /*if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
            if (mNetworkCallback != null) {  //add condition in v2.3.19
            ...
            WIFIUtil.setDefaultNetworkForInternet(mContext);
        }*/
        //]]
        //]]
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (currentSSID.equals("Dialog_DA16200")
                                    ...
                                    //|| currentSSID.equals("RZ_RRQ66620")  //remove in v2.4.9
                                ) {
                                    //]]
                                    //mConnectivityManager.unregisterNetworkCallback(mNetworkCallback);
                                    //onUnRegisterReceiver();  //add 221128
    ...
    public void getWIFIScanResult() {
        ...
        for(int i = 0; i < wifiScanList.size(); i++) {
            ...
            if (wifiScanList.get(i).SSID.equals("Dialog_DA16200")
                ...
                //|| wifiScanList.get(i).SSID.equals("RZ_RRQ66620")  //remove in v2.4.9
                //]]
            ) {
        ...
        for(int i = 0; i < specificWifiScanList.size(); i++) {
            ...
            //[[remove in v2.4.9
            /*else if (wifiName[i].equals("RZ_RRQ66620")) {
                isRenesasRRQ66620 = true;
            }*/
            //]]
        ...
        if (deviceRowItems.size() > 0) {
            ...
            //[[modify in v2.4.8
            // if (!isDialogDA16200 && !isRenesasDA16200 && isRenesasIoTWiFi && !isRenesasRRQ66620) {
            if (!isDialogDA16200 && !isRenesasDA16200 && isRenesasIoTWiFi) {  //change in v2.4.9
                ...
                if (WIFIUtil.getSSID(mContext).equals(StaticDataSave.deviceSSID)) {
                    ...
                    //WIFIUtil.setDefaultNetworkForNoInternet(mContext);  //ewmove 221128
                    //[[modify in v2.4.7
                    //onWifiConnect(StaticDataSave.deviceSSID, StaticDataSave.devicePassword);
                    ll_progressConnecting.setVisibility(View.VISIBLE);
                    WifiUtils.withContext(getApplicationContext())
                ...
                //} else if (isDialogDA16200 && !isRenesasDA16200 && !isRenesasIoTWiFi && !isRenesasRRQ66620) {
            } else if (isDialogDA16200 && !isRenesasDA16200 && !isRenesasIoTWiFi) {  //change in v2.4.9
            ...
            //[[remove in v2.4.9
                /*else if (!isDialogDA16200 && !isRenesasDA16200 & !isRenesasIoTWiFi && isRenesasRRQ66620) {
                StaticDataSave.deviceSSID = "RZ_RRQ66620";
                listView.setVisibility(View.INVISIBLE);
                mHandler.sendEmptyMessageDelayed(HandleMsg.RENESAS_AP_CONNECT_TIMEOUT, 120000);
                if (WIFIUtil.getSSID(mContext).equals(StaticDataSave.deviceSSID)) {
                    mHandler.sendEmptyMessageDelayed(HandleMsg.RENESAS_AP_CONNECTED, 1000);
