        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            /*if (goButton != null) {
                if (goButton.isEnabled()) {
                    goButton.setBackgroundColor(SelectNetworkActivity.getInstance().mContext.getResources().getColor(R.color.blue3));
                } else {
                    goButton.setBackgroundColor(SelectNetworkActivity.getInstance().mContext.getResources().getColor(R.color.dark_gray));
                }
            }*/
        }
