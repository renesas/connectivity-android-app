...
public class SensorSettingActivity extends FragmentActivity {
    ...
    public AlertDialog updateFailDialog;  //add in v2.3.17
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonKeyManage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* if(fragmentKeyManage == null){
                    fragmentKeyManage = new KeyManageFragment();
                }
                swichContent(fragmentKeyManage, KeyManageFragment.ARG_ITEM_ID);
                buttonFunctionSet.setTextColor(getResources().getColor(R.color.dark_gray));
                buttonFunctionSet.setBackgroundResource(R.drawable.tab_bg_unselected);
                buttonKeyManage.setTextColor(getResources().getColor(R.color.white));
                buttonKeyManage.setBackgroundResource(R.drawable.tab_bg_selected);
                buttonIndFcnSet.setBackgroundColor(getResources().getColor(R.color.blue5));
                buttonIndKeyMng.setBackgroundColor(Color.WHITE);*/
        ...
        if (completeDialog == null) {
            ...
            completeDialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    //[[remove in v2.3.17
                    //SensorFunctionSetFragment.badge_notification.setVisibility(View.INVISIBLE);
                    //]]
                }
            });
