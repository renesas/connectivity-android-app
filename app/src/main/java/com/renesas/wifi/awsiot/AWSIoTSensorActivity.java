...
public class AWSIoTSensorActivity extends Activity {
    ...
    //[[change in v2.4.11
    //com.wang.avi.AVLoadingIndicatorView progressingConnecting;
    ...
    public static AWSIoTSensorActivity getInstanceMain() {return instanceSensor;}
    ...
    private void sensorStatusUpdated(String statusState) {
        ...
        if (sm.metadata.reported.temperature != null) {
            ...
            Long curTemperatureTimestamp = sm.metadata.reported.temperature.timestamp;  //change type from long to Long in v2.4.0
        ...
        if (sm.metadata.reported.wakeupnum != null) {
            ...
            Long curWakeupTimestamp = sm.metadata.reported.wakeupnum.timestamp;  //change type from long to Long in v2.4.0
            if (curWakeupTimestamp != null) {  //add in v2.4.0
        ...
        if (sm.metadata.reported.OTAupdate != null) {
            ...
            Long curOtaTimestamp = sm.metadata.reported.OTAupdate.timestamp;  //change type from long to Long in v2.4.0
        ...
        if (sm.metadata.reported.OTAupdate != null) {
            ...
            if (isOtaUpdated) {
                ...
                if (ss.state.reported.OTAupdate == 0) {  //none
                    ...
                    if (ss.state.reported.OTAresult != null) {  //add null check in v2.3.14
                        ...
                        //[[remove in v2.3.17
                        /*else if (ss.state.reported.OTAresult.equals("OTA_NG")) {
    ...
    public void clickLedOffImage() {  //turn on
        ...
        if (updateDialog != null && updateDialog.isShowing()) {
            ...
            if (isMqttConnected && isDeviceConnected) {
                ...
                layerMainKey.setVisibility(View.VISIBLE);
                layerNoConnect.setVisibility(View.GONE);
                //layerNoInternet.setVisibility(View.GONE);
                if (noInternetDialog != null) {
                    noInternetDialog.dismiss();
                    noInternetDialog = null;
                }
