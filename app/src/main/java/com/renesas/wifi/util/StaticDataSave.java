...
public class StaticDataSave {
    ...
    //public static final String networkPasswordKey = "networkPasswordKey";

    public static int networkSecurityNum = -1;
    public static int isHidden = -1;
    //public static final String networkSecurityNumKey = "networkSecurityNumKey";

    //public static int completedCount = 0;
    //public static final String completedCountKey = "completedCountKey";
    ...
    //public static int checkNetworkResult = -1;
